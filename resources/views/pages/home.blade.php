...
<body>
    ...
    <section class="bg-dark-blue text-white py-3">
        ...
        <div class="container bg-dark-blue d-flex">
            <img src="{{asset('images/Logo_Universitas_Brawijaya.svg.png')}}" alt="Logo" class="mb-3" style="height: 80px;">
            <img src="{{asset('images/Logo nursing workload.png')}}" alt="Logo" class="ms-3 mb-3 border-radius-lg img-rounded" style="height: 80px;">
        </div>
    </section>
  <!-- Hero Section -->
  <section class="bg-dark-blue text-white py-5">
    <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between">
      <div class="col-md-6">
        ...
        <h1 class="text-yellow fw-bold" style="font-size: 7rem;">Nursing Workload</h1>
        <h2 class="text-white fw-bold">Calculator</h2>
        <a href="{{ route('login')}}" class="btn btn-warning mt-3 fw-bold px-4 bg-yellow text-dark text-sec text-lg rounded-xl" style="width: 200px; border: 5px white dashed">TRY</a>
      </div>
      <div class="col-md-6">
  ...
  <section class="bg-yellow py-5">
    <div class="container d-flex flex-column flex-md-row gap-5 justify-content-center">
      <div class="icon-box text-center" style="width: 300px">
        <img src="{{ asset('images/1.png')}}" alt="Admin" style="height: 150px;">
        <h3 class="mt-3 fw-bold text-primary">ADMIN</h3>
      </div>
      <div class="icon-box text-center" style="width: 300px">
        <img src="{{ asset('images/2.png')}}" alt="Perawat" style="height: 150px;">
      ...
      <div class="p-4 rounded-16 border border-dark">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 col-12">
                <h1 class="fw-bold text-primary" style="font-size: 5rem;">Tentang Kami</h1>
            ...
            <div class="col-md-6 col-12 text-center">
                <img src="{{asset('images/Logo nursing workload.png')}}" alt="Logo" class="img-fluid rounded-16 mx-auto my-auto" style="max-height: 300px;">
            </div>
        </div>
  ...
  <section class="py-5" style="background: linear-gradient(90deg, #1c2a59, #ffc736); color: white;">
    <div class="container d-flex flex-column flex-lg-row align-items-center justify-content-between">
        <div class="col-md-6 col-12">
            <h1 class="fw-bold text-white" style="font-size: 5rem;">Panduan</h1>
        ...
        <div class="col-md-6 col-12 text-center">
            ...
            <img src="{{ asset('images/3.png')}}" alt="Guide" class="img-fluid mt-4 mt-lg-0 rounded-16" style="max-height: 300px;">
        </div>
    </div>
  </section>
  ...
  <footer class="bg-dark-blue text-white py-5">
    <div class="container d-flex flex-column flex-lg-row justify-content-between align-items-center">
        <div class="col-md-6 col-12">
            ...
            <h1 class="text-yellow fw-bold" style="font-size: 5rem;">Hubungi Kami</h1>
        ...
        <div class="col-md-6 col-12">
            ...
            {{-- <img src="footer-image.png" alt="Ilustrasi" class="img-fluid" style="max-height: 100px;">
            <div class="mt-3 text-center">
              <small class="d-block">GET SOCIAL</small>
