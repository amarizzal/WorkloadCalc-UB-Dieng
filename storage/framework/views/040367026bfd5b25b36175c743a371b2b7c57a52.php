        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    <h4>Shift: <?php echo e($shiftName); ?></h4>
                    <p>Waktu Saat Ini: <?php echo e($currentTime); ?></p>
                </div>
                <hr>
                ...
                <div class="mt-4">
                    ...
                    <div class="form-group">
                        <select class="form-control tindakan-select" id="tindakanSelect" name="tindakan_id">
                            ...
                            <?php $__currentLoopData = $tindakanWaktu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tindakan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tindakan->id); ?>">
                                    <?php echo e($tindakan->tindakan); ?>
                ...
                <div class="timer-container">
                    <div class="countdown-circle">
                        <span id="timer-text" data-isRunning="<?php echo e($isTimerRunning ? 'true' : 'false'); ?>"
                            data-remainingTime="<?php echo e($sisaWaktu); ?>">
                            00:00
                        </span>
                        <svg>
                ...
                <!-- Hidden Inputs -->
                <input type="hidden" id="shiftId" name="shift_id" value="<?php echo e($shiftId); ?>">
                <input type="hidden" id="laporanId" name="laporan_id" value="<?php echo e($laporanAktif ? $laporanAktif->id : ''); ?>">
...
<?php echo $__env->make('perawat.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Documents/PERAWAT/perawat/resources/views/perawat/timer.blade.php ENDPATH**/ ?>