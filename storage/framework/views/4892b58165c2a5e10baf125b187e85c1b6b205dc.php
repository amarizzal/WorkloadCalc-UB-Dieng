    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            <div class="profile-img me-3"
                ...
                <!-- Gambar Profil -->
                <img src="<?php echo e(asset('storage/user_photos/' . auth()->user()->foto)); ?>" alt="Foto Profil"
                    style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <div>
                <h6 class="mb-0">Selamat Datang</h6>
                <small class="text-white-50"><?php echo e(auth()->user()->nama_lengkap ?? 'Guest'); ?></small>
            </div>
        </div>
...
<?php /**PATH /Users/user/Documents/PERAWAT/perawat/resources/views/perawat/layouts/header.blade.php ENDPATH**/ ?>