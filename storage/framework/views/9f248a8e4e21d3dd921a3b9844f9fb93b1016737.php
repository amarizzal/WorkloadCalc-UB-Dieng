...
<div class="container mt-4">
    ...
    <!-- Form Filter Tanggal -->
    <form method="GET" action="<?php echo e(route('admin.laporan.index5')); ?>" class="mb-3">
        <div class="row">
            <div class="col-md-4">
    ...
    <div class="table-responsive">
        <table id="laporanTable" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $tindakanTambahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tindakan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Documents/PERAWAT/perawat/resources/views/admin/laporan/laporanhasil5.blade.php ENDPATH**/ ?>